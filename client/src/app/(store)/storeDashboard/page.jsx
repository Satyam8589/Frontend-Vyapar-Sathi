    ...
    <div className="flex flex-col relative selection:bg-blue-500/20 antialiased overflow-x-hidden">
      <main className="relative z-10">
        ...
        <section className="py-3 px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 animate-fade-in-up [animation-delay:300ms]">
              {[
                ...
                <div key={i} className="bg-white/80 backdrop-blur-md rounded-2xl p-4 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <section className="py-3 px-4 md:px-6">
          <div className="max-w-7xl mx-auto transition-all duration-300 animate-fade-in-up [animation-delay:400ms]">
            <div className="bg-white/60 backdrop-blur-xl rounded-2xl p-3 border border-white/80 shadow-sm">
