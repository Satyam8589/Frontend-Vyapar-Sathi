        ...
        <div className="relative pointer-events-auto max-w-7xl mx-auto flex justify-between items-center bg-white/70 rounded-full px-5 md:px-8 py-2 border border-white/60 shadow-[0_2px_16px_rgba(0,0,0,0.08)]">
          ...
          <div className="hidden md:flex items-center gap-4">
            {!isLoading && !isAuthenticated && (
              <>
                ...
                <Link
                  href="/signUp"
                  className="btn-primary-yb py-2 px-5 md:px-6 text-sm shadow-sm"
                >
                  Get Started
                </Link>
              </>
          ...
          >
            ...
            <span className="flex flex-col gap-[5px] w-5">
              <span
                className={`block h-[2px] rounded-full bg-slate-700 transition-all duration-300 origin-center ${mobileMenuOpen ? "rotate-45 translate-y-[7px]" : ""}`}
              />
              <span
                className={`block h-[2px] rounded-full bg-slate-700 transition-all duration-300 ${mobileMenuOpen ? "opacity-0 scale-x-0" : ""}`}
              />
              <span
                className={`block h-[2px] rounded-full bg-slate-700 transition-all duration-300 origin-center ${mobileMenuOpen ? "-rotate-45 -translate-y-[7px]" : ""}`}
              />
