      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-20">
        <div className="space-y-6 md:space-y-8">
          ...
          <p className="text-slate-400 font-bold text-xs uppercase tracking-[0.2em] leading-relaxed max-w-xs">
            Leading the retail revolution with high-precision multisite
            management.
          </p>
        </div>
        ...
        {[
          {
            title: "The Suite",
            links: ["Dashboard", "Intelligence", "Security", "Compliance"],
          },
          {
            title: "Merchant House",
            links: ["Support", "Liaison", "Merchant Network", "Contact"],
          },
          {
            title: "Protocols",
            links: ["Privacy", "Sovereignty", "Terms", "Data Ethics"],
          },
        ].map((col, i) => (
          <div key={i} className="space-y-6 md:space-y-8">
            <h4 className="text-amber-400 font-black uppercase text-[10px] tracking-[0.4em] leading-none">
              {col.title}
            </h4>
